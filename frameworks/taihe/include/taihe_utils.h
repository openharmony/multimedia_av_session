...
public:
    ...
    static int32_t GetOutputDeviceInfo(OutputDeviceInfo const &in, OHOS::AVSession::OutputDeviceInfo &out);
    ...
    static int32_t GetAVCallState(const AVCallState &in, OHOS::AVSession::AVCallState &out);
    static int32_t GetAVQueueItem(const AVQueueItem &in, OHOS::AVSession::AVQueueItem &out);
    static int32_t GetAVQueueItemArray(const array<AVQueueItem> &in, std::vector<OHOS::AVSession::AVQueueItem> &out);
    ...
    static AVQueueItem ToTaiheAVQueueItem(const OHOS::AVSession::AVQueueItem &in);
    static taihe::array<AVQueueItem> ToTaiheAVQueueItemArray(const std::vector<OHOS::AVSession::AVQueueItem> &in);
    ...
    static AVPlaybackState ToTaiheAVPlaybackState(const OHOS::AVSession::AVPlaybackState &in);
    static CallMetadata ToTaiheAVCallMetaData(const OHOS::AVSession::AVCallMetaData &in);
    static AVCallState ToTaiheAVCallState(const OHOS::AVSession::AVCallState &in);
