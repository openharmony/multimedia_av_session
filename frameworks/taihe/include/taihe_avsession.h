...
public:
    ...
    void SetAVMetadataAsync(AVMetadata const &data);
    void SetAVMetadataPromise(AVMetadata const &data);
    void SetAVMetadataSync(AVMetadata const &data);
    void SetCallMetadataAsync(CallMetadata const& data);
    void SetCallMetadataPromise(CallMetadata const& data);
    void SetCallMetadataSync(CallMetadata const& data);
    void SetAVPlaybackStateAsync(AVPlaybackState const &state);
    void SetAVPlaybackStatePromise(AVPlaybackState const &state);
    void SetAVPlaybackStateSync(AVPlaybackState const &state);
    void SetAVCallStateAsync(AVCallState const& state);
    void SetAVCallStatePromise(AVCallState const& state);
    void SetAVCallStateSync(AVCallState const& state);
    void SetLaunchAbilityAsync(uintptr_t ability);
    void SetLaunchAbilityPromise(uintptr_t ability);
    void SetLaunchAbilitySync(uintptr_t ability);
    void DispatchSessionEventAsync(string_view event, uintptr_t args);
    void DispatchSessionEventPromise(string_view event, uintptr_t args);
    void DispatchSessionEventSync(string_view event, uintptr_t args);
    void SetAVQueueItemsAsync(array_view<AVQueueItem> items);
    void SetAVQueueItemsPromise(array_view<AVQueueItem> items);
    void SetAVQueueItemsSync(array_view<AVQueueItem> items);
    void SetAVQueueTitleAsync(string_view title);
    void SetAVQueueTitlePromise(string_view title);
    void SetAVQueueTitleSync(string_view title);
    void SetExtrasAsync(uintptr_t extras);
    void SetExtrasPromise(uintptr_t extras);
    void SetExtrasSync(uintptr_t extras);
    AVSessionController GetControllerAsync();
    AVSessionController GetControllerPromise();
    AVSessionController GetControllerSync();
    optional<AVCastController> GetAVCastControllerAsync();
    optional<AVCastController> GetAVCastControllerPromise();
    ...
    array<CastDisplayInfo> GetAllCastDisplaysPromise();
    array<CastDisplayInfo> GetAllCastDisplaysSync();
    void StopCastingAsync();
    void StopCastingPromise();
    void StopCastingSync();
    void ActivateAsync();
    void ActivatePromise();
    void ActivateSync();
    void DeactivateAsync();
    void DeactivatePromise();
    void DeactivateSync();
    void DestroyAsync();
    void DestroyPromise();
    void DestroySync();
    ...
    void EnableDesktopLyricPromise(bool enable);
    ...
    void SetBackgroundPlayModePromise(BackgroundPlayMode mode);
    void SetBackgroundPlayModeSync(BackgroundPlayMode mode);
    void SetMediaCenterControlTypeAsync(array_view<string> controlTypes);
    void SetMediaCenterControlTypePromise(array_view<string> controlTypes);
    void SetMediaCenterControlTypeSync(array_view<string> controlTypes);
    void SetSupportedPlaySpeedsAsync(array_view<double> speeds);
    void SetSupportedPlaySpeedsPromise(array_view<double> speeds);
    void SetSupportedPlaySpeedsSync(array_view<double> speeds);
    void SetSupportedLoopModesAsync(array_view<LoopMode> loopModes);
    void SetSupportedLoopModesPromise(array_view<LoopMode> loopModes);
    void SetSupportedLoopModesSync(array_view<LoopMode> loopModes);
