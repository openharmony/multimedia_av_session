...
// Added Async and Promise exports
TH_EXPORT_CPP_API_CreateAVSessionPromise(ANI::AVSession::CreateAVSessionSync);
TH_EXPORT_CPP_API_CreateAVSessionAsync(ANI::AVSession::CreateAVSessionSync);
TH_EXPORT_CPP_API_GetAVSessionPromise(ANI::AVSession::GetAVSessionSync);
TH_EXPORT_CPP_API_GetAllSessionDescriptorsPromise(ANI::AVSession::GetAllSessionDescriptorsSync);
TH_EXPORT_CPP_API_GetAllSessionDescriptorsAsync(ANI::AVSession::GetAllSessionDescriptorsSync);
TH_EXPORT_CPP_API_GetHistoricalSessionDescriptorsAsync(ANI::AVSession::GetHistoricalSessionDescriptorsSync);
TH_EXPORT_CPP_API_GetHistoricalSessionDescriptorsOptionalPromise(
    ANI::AVSession::GetHistoricalSessionDescriptorsOptionalSync);
TH_EXPORT_CPP_API_GetHistoricalAVQueueInfosPromise(ANI::AVSession::GetHistoricalAVQueueInfosSync);
TH_EXPORT_CPP_API_GetHistoricalAVQueueInfosAsync(ANI::AVSession::GetHistoricalAVQueueInfosSync);
TH_EXPORT_CPP_API_CreateControllerPromise(ANI::AVSession::CreateControllerSync);
TH_EXPORT_CPP_API_CreateControllerAsync(ANI::AVSession::CreateControllerSync);
TH_EXPORT_CPP_API_StartAVPlaybackPromise(ANI::AVSession::StartAVPlaybackSync);
TH_EXPORT_CPP_API_StartAVPlaybackInfoPromise(ANI::AVSession::StartAVPlaybackInfoSync);
TH_EXPORT_CPP_API_GetAVCastControllerPromise(ANI::AVSession::GetAVCastControllerSync);
TH_EXPORT_CPP_API_GetAVCastControllerAsync(ANI::AVSession::GetAVCastControllerSync);
TH_EXPORT_CPP_API_StartCastingPromise(ANI::AVSession::StartCastingSync);
TH_EXPORT_CPP_API_StartCastingAsync(ANI::AVSession::StartCastingSync);
TH_EXPORT_CPP_API_StopCastingPromise(ANI::AVSession::StopCastingSync);
TH_EXPORT_CPP_API_StopCastingAsync(ANI::AVSession::StopCastingSync);
TH_EXPORT_CPP_API_StartCastDeviceDiscoveryAsync(ANI::AVSession::StartCastDeviceDiscoverySync);
TH_EXPORT_CPP_API_StopCastDeviceDiscoveryPromise(ANI::AVSession::StopCastDeviceDiscoverySync);
TH_EXPORT_CPP_API_StopCastDeviceDiscoveryAsync(ANI::AVSession::StopCastDeviceDiscoverySync);
TH_EXPORT_CPP_API_SetDiscoverablePromise(ANI::AVSession::SetDiscoverableSync);
TH_EXPORT_CPP_API_SetDiscoverableAsync(ANI::AVSession::SetDiscoverableSync);
TH_EXPORT_CPP_API_CastAudioPromise(ANI::AVSession::CastAudioSync);
TH_EXPORT_CPP_API_CastAudioAsync(ANI::AVSession::CastAudioSync);
TH_EXPORT_CPP_API_CastAudioAllPromise(ANI::AVSession::CastAudioAllSync);
TH_EXPORT_CPP_API_GetDistributedSessionControllerPromise(ANI::AVSession::GetDistributedSessionControllerSync);
TH_EXPORT_CPP_API_IsDesktopLyricSupportedPromise(ANI::AVSession::IsDesktopLyricSupportedSync);
TH_EXPORT_CPP_API_SendSystemAVKeyEventPromise(ANI::AVSession::SendSystemAVKeyEventSync);
TH_EXPORT_CPP_API_SendSystemAVKeyEventAsync(ANI::AVSession::SendSystemAVKeyEventSync);
TH_EXPORT_CPP_API_SendSystemControlCommandPromise(ANI::AVSession::SendSystemControlCommandSync);
TH_EXPORT_CPP_API_SendSystemControlCommandAsync(ANI::AVSession::SendSystemControlCommandSync);
TH_EXPORT_CPP_API_SendSystemCommonCommandPromise(ANI::AVSession::SendSystemCommonCommandSync);
TH_EXPORT_CPP_API_SendSystemCommonCommandAsync(ANI::AVSession::SendSystemCommonCommandSync);
TH_EXPORT_CPP_API_StartDeviceLoggingPromise(ANI::AVSession::StartDeviceLoggingSync);
TH_EXPORT_CPP_API_StopDeviceLoggingPromise(ANI::AVSession::StopDeviceLoggingSync);
TH_EXPORT_CPP_API_GetSessionDescriptorsPromise(ANI::AVSession::GetSessionDescriptorsSync);

// Added export macros for startCastDeviceDiscovery overloads
TH_EXPORT_CPP_API_StartCastDeviceDiscoveryFilterAsync(ANI::AVSession::StartCastDeviceDiscoveryFilter);
TH_EXPORT_CPP_API_StartCastDeviceDiscoveryFilterDrmPromise(ANI::AVSession::StartCastDeviceDiscoveryFilterDrm);
