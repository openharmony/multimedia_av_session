...
#ifndef OHOS_NAPI_ASYNC_PROXY_H
#define OHOS_NAPI_ASYNC_PROXY_H
...
public:
    ...
    {
        napi_unwrap(env, self, reinterpret_cast<void**>(&context->objectInfo));
    }
