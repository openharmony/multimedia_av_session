...
public:
    explicit AVSessionServiceProxyFuzzerTest(const sptr<IRemoteObject>& impl) : AVSessionServiceProxy(impl) {}
    sptr<IRemoteObject> GetRemote()
    {
        return Remote();
    }
};
bool AVServiceProxySendRequestTest(uint8_t* data, size_t size);
