...
public:
    ...
    enum CastExtErrCodeAPI12 : ErrCode {
        // Generic error
        CAST_GENERICERR_EXT_API12_UNSPECIFIED = 6611000,
        CAST_GENERICERR_EXT_API12_REMOTE_ERRO,
        CAST_GENERICERR_EXT_API12_BEHIND_LIVE_WINDOW,
        CAST_GENERICERR_EXT_API12_TIMEOUT,
        CAST_GENERICERR_EXT_API12_FAILED_RUNTIME_CHECK,
        CAST_GENERICERR_EXT_API12_PLAYER_ERROR = 6611100,
        CAST_GENERICERR_EXT_API12_SEEK_MODE_UNSUPPORTED,
        CAST_GENERICERR_EXT_API12_ILLEGAL_SEEK_TARGET,
        CAST_GENERICERR_EXT_API12_PLAY_MODE_UNSUPPORTED,
        CAST_GENERICERR_EXT_API12_PLAY_SPEED_UNSUPPORTED,
        CAST_GENERICERR_EXT_API12_DEVICE_MISSED,
        CAST_GENERICERR_EXT_API12_INVALID_PARAM,
        CAST_GENERICERR_EXT_API12_CONNECT_FAILED,
        CAST_GENERICERR_EXT_API12_OPERATION_NOT_ALLOWED,
        // Input/Output errors
        CAST_IOERR_EXT_API12_UNSPECIFIED = 6612000,
        CAST_IOERR_EXT_API12_NETWORK_CONNECTION_FAILED,
        CAST_IOERR_EXT_API12_NETWORK_CONNECTION_TIMEOUT,
        CAST_IOERR_EXT_API12_INVALID_HTTP_CONTENT_TYPE,
        CAST_IOERR_EXT_API12_BAD_HTTP_STATUS,
        CAST_IOERR_EXT_API12_FILE_NOT_FOUND,
        CAST_IOERR_EXT_API12_NO_PERMISSION,
        CAST_IOERR_EXT_API12_CLEARTEXT_NOT_PERMITTED,
        CAST_IOERR_EXT_API12_READ_POSITION_OUT_OF_RANGE,
        CAST_IOERR_EXT_API12_NO_CONTENTS,
        CAST_IOERR_EXT_API12_READ_ERROR,
        CAST_IOERR_EXT_API12_CONTENT_BUSY,
        CAST_IOERR_EXT_API12_CONTENT_EXPIRED,
        CAST_IOERR_EXT_API12_CONTENT_NON_ALLOWED_USE,
        CAST_IOERR_EXT_API12_CONTENT_CANNOT_VERIFIED,
        CAST_IOERR_EXT_API12_CONTENT_EXHAUSTED_ALLOWED_USES,
        CAST_IOERR_EXT_API12_NETWORK_PACKET_SENDING_FAILURE,
        // Content parsing errors
        CAST_PARSINGERR_EXT_API12_UNSPECIFIED = 6613000,
        CAST_PARSINGERR_EXT_API12_CONTAINER_MALFORMED,
        CAST_PARSINGERR_EXT_API12_MANIFEST_MALFORMED,
        CAST_PARSINGERR_EXT_API12_CONTAINER_UNSUPPORTED,
        CAST_PARSINGERR_EXT_API12_MANIFEST_UNSUPPORTED,
        // Decoding errors
        CAST_DECODEERR_EXT_API12_UNSPECIFIED = 6614000,
        CAST_DECODEERR_EXT_API12_INIT_FAILED,
        CAST_DECODEERR_EXT_API12_QUERY_FAILED,
        CAST_DECODEERR_EXT_API12_FAILED,
        CAST_DECODEERR_EXT_API12_FORMAT_EXCEEDS_CAPABILITIES,
        CAST_DECODEERR_EXT_API12_FORMAT_UNSUPPORTED,
        // AudioRender errors
        CAST_RENDERERR_EXT_API12_UNSPECIFIED = 6615000,
        CAST_RENDERERR_EXT_API12_INIT_FAILED,
        CAST_RENDERERR_EXT_API12_WRITE_FAILED,
        // DRM errors
        CAST_DRMERR_EXT_API12_UNSPECIFIED = 6616000,
        CAST_DRMERR_EXT_API12_SCHEME_UNSUPPORTED,
        CAST_DRMERR_EXT_API12_PROVISIONING_FAILED,
        CAST_DRMERR_EXT_API12_CONTENT_ERROR,
        CAST_DRMERR_EXT_API12_LICENSE_ACQUISITION_FAILED,
        CAST_DRMERR_EXT_API12_DISALLOWED_OPERATION,
        CAST_DRMERR_EXT_API12_SYSTEM_ERROR,
        CAST_DRMERR_EXT_API12_DEVICE_REVOKED,
        CAST_DRMERR_EXT_API12_LICENSE_EXPIRED,
        CAST_DRMERR_EXT_API12_PROVIDE_KEY_RESPONSE_ERROR = 6616100,
    };
    ...
    enum CastErrCode : ErrCode {
        ...
        ERROR_CODE_GENERIC_START = ERROR_OPERATION_NOT_ALLOWED,
        // Input/Output errors
        ERROR_CODE_IO_START = 2000,
        ERROR_CODE_IO_UNSPECIFIED = ERROR_CODE_IO_START,
        ERROR_CODE_IO_NETWORK_CONNECTION_FAILED,
        ERROR_CODE_IO_NETWORK_CONNECTION_TIMEOUT,
        ERROR_CODE_IO_INUALID_HTTP_CONTENT_TYPE,
        ERROR_CODE_IO_BAD_HTTP_STATUS,
        ERROR_CODE_IO_FILE_NOT_FOUND,
        ERROR_CODE_IO_NO_PERMISSION,
        ERROR_CODE_IO_CLEARTEXT_NOT_PERMIIED,
        ERROR_CODE_IO_READ_POSITION_OUT_OF_RANGE,
        ERROR_CODE_IO_NO_CONTENTS,
        ERROR_CODE_IO_READ_ERRORS,
        ...
        // Content parsing errors
        ERROR_CODE_PARSING_START = 30000,
        ...
        ERROR_CODE_DRM_PROVIDE_KEY_PESPONSE_ERROR,
    ...
    const std::map<CastErrCode, std::string> CAST_GENERIC_ERRCODE_INFOS = {
        ...
        {ERROR_CODE_REMOTE_ERRO, "An unspecified error occurs in the remote player"},
        ...
        {ERROR_CODE_ILLEGAL_SEEK_TARGET, "The position to seek to is out of the range of
            the media asset or the specified seek mode is not supported"},
        ...
        {ERROR_CODE_DEVICE_MISSED, "The action failed because either the media source devce or
            the media sink device has been revoked"},
        {ERROR_CODE_INVALID_PARAM, ""},
        {ERROR_CONNECT_FAILED, ""},
        {ERROR_OPERATION_NOT_ALLOWED, ""},
    };
    ...
    const std::map<CastErrCode, std::string> CAST_PARSING_ERRCODE_INFOS = {
        {ERROR_CODE_PARSING_UNSPECIFIED, ""},
        {ERROR_CODE_PARSING_CONTAINER_MALFORMED, ""},
        {ERROR_CODE_PARSING_MANIFEST_MALFORMED, ""},
        {ERROR_CODE_PARSING_CONTAINER_UNSUPPORTED, ""},
        {ERROR_CODE_PARSING_MANIFEST_UNSUPPORTED, ""},
    ...
    const std::map<CastErrCode, std::string> CAST_RENDER_ERRCODE_INFOS = {
        {ERROR_CODE_AUDIO_RENDERS_UNSPECIFIED, ""},
        {ERROR_CODE_AUDIO_RENDERS_INIT_FAILED, ""},
        {ERROR_CODE_AUDIO_RENDERS_WRITE_FAILED, ""},
    };
    // DRM errors
    ...
    const std::map<CastErrCode, CastExtErrCodeAPI12> CASTERRCODE_TO_EXTERRORCODEAPI12 = {
        // Generic error
        {ERROR_CODE_UNSPECIFIED,                        CAST_GENERICERR_EXT_API12_UNSPECIFIED},
        {ERROR_CODE_REMOTE_ERRO,                        CAST_GENERICERR_EXT_API12_REMOTE_ERRO},
        {ERROR_CODE_BEHIND_LIVE_WINDOW,                 CAST_GENERICERR_EXT_API12_BEHIND_LIVE_WINDOW},
        {ERROR_CODE_TIMEOUT,                            CAST_GENERICERR_EXT_API12_TIMEOUT},
        {ERROR_CODE_FAILED_RUNTIME_CHECK,               CAST_GENERICERR_EXT_API12_FAILED_RUNTIME_CHECK},
        {ERROR_CODE_PLAYER_ERROR,                       CAST_GENERICERR_EXT_API12_PLAYER_ERROR},
        {ERROR_CODE_SEEK_MODE_UNSUPPORTED,              CAST_GENERICERR_EXT_API12_SEEK_MODE_UNSUPPORTED},
        {ERROR_CODE_ILLEGAL_SEEK_TARGET,                CAST_GENERICERR_EXT_API12_ILLEGAL_SEEK_TARGET},
        {ERROR_CODE_PLAY_MODE_UNSUPPORTED,              CAST_GENERICERR_EXT_API12_PLAY_MODE_UNSUPPORTED},
        {ERROR_CODE_PLAY_SPEED_UNSUPPORTED,             CAST_GENERICERR_EXT_API12_PLAY_SPEED_UNSUPPORTED},
        {ERROR_CODE_DEVICE_MISSED,                      CAST_GENERICERR_EXT_API12_DEVICE_MISSED},
        {ERROR_CODE_INVALID_PARAM,                      CAST_GENERICERR_EXT_API12_INVALID_PARAM},
        {ERROR_CONNECT_FAILED,                          CAST_GENERICERR_EXT_API12_CONNECT_FAILED},
        {ERROR_OPERATION_NOT_ALLOWED,                   CAST_GENERICERR_EXT_API12_OPERATION_NOT_ALLOWED},
        // Input/Output errors
        {ERROR_CODE_IO_UNSPECIFIED,                     CAST_IOERR_EXT_API12_UNSPECIFIED},
        {ERROR_CODE_IO_NETWORK_CONNECTION_FAILED,       CAST_IOERR_EXT_API12_NETWORK_CONNECTION_FAILED},
        {ERROR_CODE_IO_NETWORK_CONNECTION_TIMEOUT,      CAST_IOERR_EXT_API12_NETWORK_CONNECTION_TIMEOUT},
        {ERROR_CODE_IO_INUALID_HTTP_CONTENT_TYPE,       CAST_IOERR_EXT_API12_INUALID_HTTP_CONTENT_TYPE},
        {ERROR_CODE_IO_BAD_HTTP_STATUS,                 CAST_IOERR_EXT_API12_BAD_HTTP_STATUS},
        {ERROR_CODE_IO_FILE_NOT_FOUND,                  CAST_IOERR_EXT_API12_FILE_NOT_FOUND},
        {ERROR_CODE_IO_NO_PERMISSION,                   CAST_IOERR_EXT_API12_NO_PERMISSION},
        {ERROR_CODE_IO_CLEARTEXT_NOT_PERMIIED,          CAST_IOERR_EXT_API12_CLEARTEXT_NOT_PERMIIED},
        {ERROR_CODE_IO_READ_POSITION_OUT_OF_RANGE,      CAST_IOERR_EXT_API12_READ_POSITION_OUT_OF_RANGE},
        {ERROR_CODE_IO_NO_CONTENTS,                     CAST_IOERR_EXT_API12_NO_CONTENTS},
        {ERROR_CODE_IO_READ_ERRORS,                     CAST_IOERR_EXT_API12_READ_ERRORS},
        {ERROR_CODE_IO_CONTENT_BUSY,                    CAST_IOERR_EXT_API12_CONTENT_BUSY},
        {ERROR_CODE_IO_CONTENT_EXPIRED,                 CAST_IOERR_EXT_API12_CONTENT_EXPIRED},
        {ERROR_CODE_IO_CONTENT_CANNOT_VERIFIED,         CAST_IOERR_EXT_API12_CONTENT_CANNOT_VERIFIED},
        {ERROR_CODE_IO_CONTENT_EXHAUSTED_ALLOWED_USES,  CAST_IOERR_EXT_API12_CONTENT_EXHAUSTED_ALLOWED_USES},
        {ERROR_CODE_IO_NETWORK_PACKET_SENDING_FAILURE,  CAST_IOERR_EXT_API12_NETWORK_PACKET_SENDING_FAILURE},
        // Content parsing errors
        {ERROR_CODE_PARSING_UNSPECIFIED,                CAST_PARSINGERR_EXT_API12_UNSPECIFIED},
        {ERROR_CODE_PARSING_CONTAINER_MALFORMED,        CAST_PARSINGERR_EXT_API12_CONTAINER_MALFORMED},
        {ERROR_CODE_PARSING_MANIFEST_MALFORMED,         CAST_PARSINGERR_EXT_API12_MANIFEST_MALFORMED},
        {ERROR_CODE_PARSING_CONTAINER_UNSUPPORTED,      CAST_PARSINGERR_EXT_API12_CONTAINER_UNSUPPORTED},
        {ERROR_CODE_PARSING_MANIFEST_UNSUPPORTED,       CAST_PARSINGERR_EXT_API12_MANIFEST_UNSUPPORTED},
        // Decoding errors
        {ERROR_CODE_DECODE_UNSPECIFIED,                 CAST_DECODEERR_EXT_API12_UNSPECIFIED},
        {ERROR_CODE_DECODER_INIT_FAILED,                CAST_DECODEERR_EXT_API12_INIT_FAILED},
        {ERROR_CODE_DECODER_QUERY_FAILED,               CAST_DECODEERR_EXT_API12_QUERY_FAILED},
        {ERROR_CODE_DECODING_FAILED,                    CAST_DECODEERR_EXT_API12_FAILED},
        {ERROR_CODE_DECODING_FORMAT_EXCEEDS_CAPABILITIES, CAST_DECODEERR_EXT_API12_FORMAT_EXCEEDS_CAPABILITIES},
        {ERROR_CODE_DECODING_FORMAT_UNSUPPORTED,        CAST_DECODEERR_EXT_API12_FORMAT_UNSUPPORTED},
        // AudioRender errors
        {ERROR_CODE_AUDIO_RENDERS_UNSPECIFIED,          CAST_RENDERERR_EXT_API12_UNSPECIFIED},
        {ERROR_CODE_AUDIO_RENDERS_INIT_FAILED,          CAST_RENDERERR_EXT_API12_INIT_FAILED},
        {ERROR_CODE_AUDIO_RENDERS_WRITE_FAILED,         CAST_RENDERERR_EXT_API12_WRITE_FAILED},
        // DRM errors
        {ERROR_CODE_DRM_UNSPECIFIED,                    CAST_DRMERR_EXT_API12_UNSPECIFIED},
        {ERROR_CODE_DRM_SCHEME_UNSUPPORTED,             CAST_DRMERR_EXT_API12_SCHEME_UNSUPPORTED},
        {ERROR_CODE_DRM_PROVISIONING_FAILED,            CAST_DRMERR_EXT_API12_PROVISIONING_FAILED},
        {ERROR_CODE_DRM_CONTENT_ERROR,                  CAST_DRMERR_EXT_API12_CONTENT_ERROR},
        {ERROR_CODE_DRM_LICENSE_ACQUISITION_FAILED,     CAST_DRMERR_EXT_API12_LICENSE_ACQUISITION_FAILED},
        {ERROR_CODE_DRM_DISALLOWED_OPERATION,           CAST_DRMERR_EXT_API12_DISALLOWED_OPERATION},
        {ERROR_CODE_DRM_SYSTEM_ERROR,                   CAST_DRMERR_EXT_API12_SYSTEM_ERROR},
        {ERROR_CODE_DRM_DEVICE_REVOKED,                 CAST_DRMERR_EXT_API12_DEVICE_REVOKED},
        {ERROR_CODE_DRM_LICENSE_EXPIRED,                CAST_DRMERR_EXT_API12_LICENSE_EXPIRED},
        {ERROR_CODE_DRM_PROVIDE_KEY_PESPONSE_ERROR,     CAST_DRMERR_EXT_API12_PROVIDE_KEY_PESPONSE_ERROR},
    };
...
private:
    ...
    void HandlePlayerErrorAPI12(const int32_t errorCode, const std::string& errorMsg);
