...
private:
    ...
    static napi_status GetDataSrc(napi_env env, napi_value in, AVMediaDescription& out);
    static napi_status SetDataSrc(napi_env env, const AVMediaDescription& in, napi_value& out);

    static napi_status GetPcmSrc(napi_env env, napi_value in, AVMediaDescription& out);
    static napi_status SetPcmSrc(napi_env env, const AVMediaDescription& in, napi_value& out);
