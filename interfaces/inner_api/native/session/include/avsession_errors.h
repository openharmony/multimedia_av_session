...
constexpr int32_t  ERR_WAIT_ALLCONNECT_TIMEOUT = -(AVSESSION_ERROR_BASE + 24);
constexpr int32_t  ERR_ALLCONNECT_CAST_REJECT = -(AVSESSION_ERROR_BASE + 25);
constexpr int32_t  ERR_ALLCONNECT_PREEMPTED_BY_OTHERS = -(AVSESSION_ERROR_BASE + 26);
constexpr int32_t  ERR_REPEAT_CAST = -(AVSESSION_ERROR_BASE + 27);
constexpr int32_t  ERR_DESKTOPLYRIC_NOT_SUPPORT = -(AVSESSION_ERROR_BASE + 28);
constexpr int32_t  ERR_DESKTOPLYRIC_NOT_ENABLE = -(AVSESSION_ERROR_BASE + 29);
constexpr int32_t  ERR_AUDIO_ZONE_NOT_FOUND = -(AVSESSION_ERROR_BASE + 30);
}  // namespace OHOS::AVSession
