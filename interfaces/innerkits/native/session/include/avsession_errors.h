...
constexpr int MODULE_AVSESSION = 0;
constexpr int SUBSYS_AVSESSION = 50;
constexpr int32_t BASE_SESSION_ERR_OFFSET = ErrCodeOffset(SUBSYS_AVSESSION, MODULE_AVSESSION);

constexpr int32_t  AVSESSION_ERROR = -1;
constexpr int32_t  AVSESSION_SUCCESS = 0;
constexpr int32_t  AVSESSION_ERROR_BASE = BASE_SESSION_ERR_OFFSET;
