...
inline const std::string DEV_PHONE = "00E";
inline const std::string DEV_LAPTOP = "00C";
inline const std::string AVSESSION_PKG_NAME = "av_session";
inline const std::string CAST_ENGINE_PKG = "cast_engine_service";
inline const std::string MEDIA_CONTROL_PKG = "mediacontroller";
}
