...
enum AVSessionTraceTaskId : int32_t {
    ...
    NAPI_CAST_CONTROLLER_SEND_CONTROL_COMMAND_TASK_ID = 20,
    NAPI_CAST_CONTROLLER_START_TASK_ID = 21,
    NAPI_CAST_CONTROLLER_UPDATE_MEDIA_INFO_TASK_ID = 22,
    NAPI_CAST_CONTROLLER_GET_DURATION_TASK_ID = 22,
    NAPI_CAST_CONTROLLER_GET_POSITION_TASK_ID = 22,
    NAPI_CAST_CONTROLLER_GET_VOLUME_TASK_ID = 22,
    NAPI_CAST_CONTROLLER_GET_LOOPMODE_TASK_ID = 22,
    NAPI_CAST_CONTROLLER_GET_PLAY_SPEED_TASK_ID = 22,
    NAPI_CAST_CONTROLLER_GET_PLAY_STATE_TASK_ID = 22,
    NAPI_CAST_CONTROLLER_SET_DISPLAY_SURFACE_TASK_ID = 22,
};
#ifdef ENBABLE_AVSESSION_TRACE_CONTROL
