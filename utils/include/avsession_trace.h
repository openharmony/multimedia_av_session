...
enum AVSessionTraceTaskId : int32_t {
    ...
    NAPI_CAST_PICKER_HELPER_TASK_ID = 38,
    NAPI_CAST_CONTROL_GET_SUPPORT_DECODER_ID = 39,
    NAPI_CAST_CONTROL_GET_RECOMMEND_RESOLUTION_LEVEL_ID = 40,
    NAPI_CAST_CONTROL_GET_SUPPORT_HDR_CAPABILITIES_ID = 41,
    NAPI_CAST_CONTROL_GET_SUPPORT_PLAY_SPEED_ID = 42,
};
#ifdef ENBABLE_AVSESSION_TRACE_CONTROL
