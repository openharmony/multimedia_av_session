...
enum AVSessionTraceTaskId : int32_t {
    ...
    ON_PLAYBACK_STATE_CHANGE_TASK_ID,
    ON_MEDA_DATA_CHANGE_TASK_ID,
    ON_ACTIVE_STATE_CHANGE_TASK_ID,
    ON_VALID_COMMAND_CHANGE_TASK_ID,
    ON_SESSION_CALLBACK_PLAY_TASK_ID,
    ON_SESSION_CALLBACK_PAUSE_TASK_ID,
    ON_SESSION_CALLBACK_STOP_TASK_ID,
    ON_SESSION_CALLBACK_PLAY_NEXT_TASK_ID,
    ON_SESSION_CALLBACK_PLAY_PREVIOUS_TASK_ID,
    ON_SESSION_CALLBACK_FAST_FORWARD_TASK_ID,
    ON_SESSION_CALLBACK_REWIND_TASK_ID,
    ON_SESSION_CALLBACK_SEEK_TASK_ID,
    ON_SESSION_CALLBACK_SET_SPEED_TASK_ID,
    ON_SESSION_CALLBACK_SET_LOOP_MODE_TASK_ID,
    ON_SESSION_CALLBACK_TOGGLE_FAVORITE_TASK_ID,
    ON_SESSION_CALLBACK_MEDIA_KEY_EVENT_TASK_ID,
    ON_SESSION_SERVICE_CLIENT_DIED_TASK_ID,
    ON_SESSION_SERVICE_ADD_SYSTEM_ABILITY_TASK_ID,
    ON_SESSION_CREATE_TASK_ID,
    ON_SESSION_RELEASE_TASK_ID,
    ON_TOP_SESSION_CHANGED_TASK_ID,
