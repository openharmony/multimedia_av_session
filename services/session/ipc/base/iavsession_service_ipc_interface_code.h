...
enum class AvsessionSeviceInterfaceCode {
    ...
    SERVICE_CMD_REGISTER_ANCO_MEDIA_SESSION_LISTENER,
    SERVICE_CMD_GET_SESSION,
    SERVICE_CMD_GET_SESSION_DESCRIPTORS,
    SERVICE_CMD_IS_DESKTOP_LYRIC_FEATURE_SUPPORTED,
#ifdef CAR_FEATURE_ENABLE
    SERVICE_CMD_REGISTER_SESSION_LISTENER_FOR_USER,
    SERVICE_CMD_GET_SESSION_DESCRIPTORS_FOR_AUDIO_ZONE,
    SERVICE_CMD_START_AV_PLAYBACK_FOR_ZONE,
#endif
    SERVICE_CMD_MAX
};
} // namespace OHOS::AVSession
