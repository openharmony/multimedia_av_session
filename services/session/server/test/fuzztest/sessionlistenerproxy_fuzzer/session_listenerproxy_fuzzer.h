...
#ifndef OHOS_SESSIONLISTENERPROXY_FUZZER_H
#define OHOS_SESSIONLISTENERPROXY_FUZZER_H
#include <cstdint>
...
bool SessionListenerProxySendRequestTest(uint8_t* data, size_t size);

class SessionListenerProxyFuzzer {
public:
    SessionListenerProxyFuzzer() = default;
    ~SessionListenerProxyFuzzer() = default;
