...
constexpr size_t MAX_COMMANDS_STR_LENGTH = 64;
...
constexpr int32_t SYNC_MEDIASESSION_CALLBACK_ON_SEEK = 51;
constexpr int32_t SYNC_MEDIASESSION_CALLBACK_ON_SET_LOOP_MODE = 52;
...
const char* METADATA_DURATION = "MetadataDuration";
