...
#ifndef COLLABORATION_MANAGER_HIPLAY_H
#define COLLABORATION_MANAGER_HIPLAY_H

#include <mutex>
#include "collaboration_manager.h"

namespace OHOS::AVSession {
class CollaborationManagerHiPlay : public CollaborationManager {
public:
