...
int32_t CollaborationManager::CastAddToCollaboration(const DeviceInfo& deviceInfo)
{
    ...
    CHECK_AND_RETURN_RET_LOG(deviceInfo.realDeviceId_ != "", AVSESSION_ERROR, "deviceid is empty");
    ...
    ApplyAdvancedResource(deviceInfo.realDeviceId_.c_str(), deviceInfo, checkLinkConflict);
