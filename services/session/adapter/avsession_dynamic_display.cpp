...
#include "avsession_dynamic_display.h"
...
{
    SLOGI("DisplayAdapter ctor");
}

void DisplayAdapter::GetAllCastDisplays(std::vector<CastDisplayInfo>& castDisplays)
{
...
void DisplayAdapter::StartCastDisplayListener(sptr<IAVSessionCallback> callback)
{
    if (displayListener_ == nullptr) {
...
int32_t DisplayAdapter::StopCastDisplayListener()
{
...
extern "C" AVSessionDisplayIntf *createAVSessionDisplayIntf()
{
